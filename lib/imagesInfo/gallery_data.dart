...
final List<GalleryItem> galleryData = [
  GalleryItem(
    imageTitle: 'Marcel und ich auf W:O:A 2009',
    imageDate: '04.08.2009',
    imageDescription:
        'Zwei gute Freunde am feiern zu irre lauter Musik und mit Bierchen in den Händen.',
    imagePath: 'assets/images/wacken2009_marcelundich.JPG',
  ),
  GalleryItem(
    imageTitle: 'John und ich auf W:O:A 2009',
    imageDate: '05.08.2009',
    imageDescription:
        'Zwei gute betrunkene Freunde am feiern zu irre lauter Musik.',
    imagePath: 'assets/images/wacken2009_johnundich.JPG',
  ),
  GalleryItem(
    imageTitle: 'Swish',
